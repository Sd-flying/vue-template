...
export const asyncRouterMap = [{
    path: "/home",
    component: Layout,
    meta: { title: "首页布局", icon: "el-icon-menu" }
},
{
    path: "/map",
    component: Layout,
    redirect: "/map/index",
    name: "map",
    meta: { title: "地图", icon: "el-icon-tickets", role: ['0', '1', '2'] },
    children: [{
        path: "index.scss",
        name: "卫星图",
        component: () =>
            import("@/views/mapTest/index"),
        meta: { title: "卫星图", role: ['0'] },
    },
    {
        path: "1-2",
        name: "1-2",
        component: () =>
            import("@/views/mapTest/1-2"),
        hidden: ['0'],//用户角色为0时，隐藏
...
},
{
    path: "/bigScreen",
    component: Layout,
    redirect: "/bigScreen/tree",
    name: "bigScreen",
    meta: { title: "大屏展示", icon: "el-icon-tickets", role: ['0', '1'] },
    children: [{
        path: "2-1",
        name: "2-1",
        component: () =>
            import("@/views/bigScreen/2-1"),
        meta: { title: "大屏页面", role: ['0'] }
    },
    {
        path: "2-2",
        name: "2-2",
        component: () =>
            import("@/views/bigScreen/2-2"),
        hidden: ['0'],//用户角色为0时，隐藏
